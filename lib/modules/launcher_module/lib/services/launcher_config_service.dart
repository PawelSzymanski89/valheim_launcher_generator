...
class LauncherConfigService {
  ...
  /// Priority:
  ///   1. Encrypted config_encrypted.json (generated by Valheim Launcher Generator)
  ///   2. Encrypted launcher_config.json (legacy per-install encryption)
  ///   3. PlainJSON launcher_config.json (migration)
  ///   4. Defaults (empty)
